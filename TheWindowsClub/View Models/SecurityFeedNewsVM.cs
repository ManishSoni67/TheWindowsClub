...
{
    public class SecurityFeedNewsVM:BaseModel
    {
        public SecurityFeedNewsVM()
        {
            Oninit();
        }
        ...
        private void AttachEvent()
        {
            FirstTile.ImaegLoaded += (s, e) =>
            {
                ...
                {
                    FirstTile.Image = new BitmapImage(App.DefaultSecurity);
                }
            ...
            SeconTile.ImaegLoaded += (s, e) =>
            {
                ...
                {
                    SeconTile.Image = new BitmapImage(App.DefaultSecurity);
                }
            };
            ThirdTile.ImaegLoaded += (s, e) =>
            {
                ...
                {
                    ThirdTile.Image = new BitmapImage(App.DefaultSecurity);
                }
            };
            ForthTile.ImaegLoaded += (s, e) =>
            {
                ...
                {
                    ForthTile.Image = new BitmapImage(App.DefaultSecurity);
                }
            ...
            FifthTile.ImaegLoaded += (s, e) =>
            {
                ...
                {
                    FifthTile.Image = new BitmapImage(App.DefaultSecurity);
                }
            };
            SixthTile.ImaegLoaded += (s, e) =>
            {
                ...
                {
                    SixthTile.Image = new BitmapImage(App.DefaultSecurity);
                }
            };
            SeventhTile.ImaegLoaded += (s, e) =>
            {
                ...
                {
                    SeventhTile.Image = new BitmapImage(App.DefaultSecurity);
                }
            };
            EightthTile.ImaegLoaded += (s, e) =>
            {
                ...
                {
                    EightthTile.Image = new BitmapImage(App.DefaultSecurity);
                }
            };
            NinthTile.ImaegLoaded += (s, e) =>
            {
                ...
                {
                    NinthTile.Image = new BitmapImage(App.DefaultSecurity);
                }
            };
            TenthModel.ImaegLoaded += (s, e) =>
            {
                ...
                {
                    TenthModel.Image = new BitmapImage(App.DefaultSecurity);
                }
        ...
        public void LoadRss()
        {
            Uri ur = new Uri(App.SecurityFeedSource, UriKind.Absolute);
            ...
            wb.OpenReadCompleted += (s, e) =>
            {
                ...
                if (e.Error != null)
                {
                    ...
                    if (fs.FileExists(App.XMLSecurityDoc))
                    {
                        using (IsolatedStorageFileStream file = fs.OpenFile(App.XMLSecurityDoc, FileMode.Open, FileAccess.Read, FileShare.Read))
                        {
                ...
                else
                {
                    ...
                    if (fs.FileExists(App.XMLSecurityDoc))
                    {
                        fs.DeleteFile(App.XMLSecurityDoc);
                    }
                    using (IsolatedStorageFileStream file = fs.CreateFile(App.XMLSecurityDoc))
                    {
        ...
        private void CheckForallImages()
        {
            ...
            if (AllData != null)
            {
                ...
                {
                    data.Image = new BitmapImage(App.DefaultSecurity);
                }
            }
