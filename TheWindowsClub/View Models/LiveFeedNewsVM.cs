...
{
    public class LiveFeedNewsVM:BaseModel
    {
        public LiveFeedNewsVM()
        {
            Oninit();
        }
        ...
        private void AttachEvent()
        {
            FirstTile.ImaegLoaded += (s, e) =>
            {
                ...
                {
                    FirstTile.Image = new BitmapImage(App.DefaultLiveUri);
                }
            ...
            SeconTile.ImaegLoaded += (s, e) =>
            {
                ...
                {
                    SeconTile.Image = new BitmapImage(App.DefaultLiveUri);
                }
            };
            ThirdTile.ImaegLoaded += (s, e) =>
            {
                ...
                {
                    ThirdTile.Image = new BitmapImage(App.DefaultLiveUri);
                }
            };
            ForthTile.ImaegLoaded += (s, e) =>
            {
                ...
                {
                    ForthTile.Image = new BitmapImage(App.DefaultLiveUri);
                }
            ...
            FifthTile.ImaegLoaded += (s, e) =>
            {
                ...
                {
                    FifthTile.Image = new BitmapImage(App.DefaultLiveUri);
                }
            };
            SixthTile.ImaegLoaded += (s, e) =>
            {
                ...
                {
                    SixthTile.Image = new BitmapImage(App.DefaultLiveUri);
                }
            };
            SeventhTile.ImaegLoaded += (s, e) =>
            {
                ...
                {
                    SeventhTile.Image = new BitmapImage(App.DefaultLiveUri);
                }
            };
            EightthTile.ImaegLoaded += (s, e) =>
            {
                ...
                {
                    EightthTile.Image = new BitmapImage(App.DefaultLiveUri);
                }
            };
            NinthTile.ImaegLoaded += (s, e) =>
            {
                ...
                {
                    NinthTile.Image = new BitmapImage(App.DefaultLiveUri);
                }
            };
            TenthModel.ImaegLoaded += (s, e) =>
            {
                ...
                {
                    TenthModel.Image = new BitmapImage(App.DefaultLiveUri);
                }
        ...
        public void LoadRss()
        {
            Uri ur = new Uri(App.LiveFeedSource, UriKind.Absolute);
            ...
            wb.OpenReadCompleted += (s, e) =>
            {
                ...
                if (e.Error != null)
                {
                    ...
                    if (fs.FileExists(App.XMLLiveDoc))
                    {
                        using (IsolatedStorageFileStream file = fs.OpenFile(App.XMLLiveDoc, FileMode.Open, FileAccess.Read, FileShare.Read))
                        {
                ...
                else
                {
                    ...
                    if (fs.FileExists(App.XMLLiveDoc))
                    {
                        fs.DeleteFile(App.XMLLiveDoc);
                    }
                    using (IsolatedStorageFileStream file = fs.CreateFile(App.XMLLiveDoc))
                    {
        ...
        private void CheckForallImages()
        {
            ...
            if (AllData != null)
            {
                ...
                {
                    data.Image = new BitmapImage(App.DefaultLiveUri);
                }
            }
