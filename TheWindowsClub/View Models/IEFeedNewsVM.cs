...
{
   public class IEFeedNewsVM:BaseModel
    {
       public IEFeedNewsVM()
       {
           Oninit();
       ...
       private void AttachEvent()
       {
           FirstTile.ImaegLoaded += (s, e) =>
           {
               ...
               {
                   FirstTile.Image = new BitmapImage(App.DefaultIEUri);
               }
           ...
           SeconTile.ImaegLoaded += (s, e) =>
           {
               ...
               {
                   SeconTile.Image = new BitmapImage(App.DefaultIEUri);
               }
           };
           ThirdTile.ImaegLoaded += (s, e) =>
           {
               ...
               {
                   ThirdTile.Image = new BitmapImage(App.DefaultIEUri);
               }
           };
           ForthTile.ImaegLoaded += (s, e) =>
           {
               ...
               {
                   ForthTile.Image = new BitmapImage(App.DefaultIEUri);
               }
           ...
           FifthTile.ImaegLoaded += (s, e) =>
           {
               ...
               {
                   FifthTile.Image = new BitmapImage(App.DefaultIEUri);
               }
           };
           SixthTile.ImaegLoaded += (s, e) =>
           {
               ...
               {
                   SixthTile.Image = new BitmapImage(App.DefaultIEUri);
               }
           };
           SeventhTile.ImaegLoaded += (s, e) =>
           {
               ...
               {
                   SeventhTile.Image = new BitmapImage(App.DefaultIEUri);
               }
           };
           EightthTile.ImaegLoaded += (s, e) =>
           {
               ...
               {
                   EightthTile.Image = new BitmapImage(App.DefaultIEUri);
               }
           };
           NinthTile.ImaegLoaded += (s, e) =>
           {
               ...
               {
                   NinthTile.Image = new BitmapImage(App.DefaultIEUri);
               }
           };
           TenthModel.ImaegLoaded += (s, e) =>
           {
               ...
               {
                   TenthModel.Image = new BitmapImage(App.DefaultIEUri);
               }
       ...
       public void LoadRss()
       {
           Uri ur = new Uri(App.IEFeedSource, UriKind.Absolute);
           ...
           wb.OpenReadCompleted += (s, e) =>
           {
               ...
               if (e.Error != null)
               {
                   ...
                   if (fs.FileExists(App.XMLIEDoc))
                   {
                       using (IsolatedStorageFileStream file = fs.OpenFile(App.XMLIEDoc, FileMode.Open, FileAccess.Read, FileShare.Read))
                       {
               ...
               else
               {
                   ...
                   if (fs.FileExists(App.XMLIEDoc))
                   {
                       fs.DeleteFile(App.XMLIEDoc);
                   }
                   using (IsolatedStorageFileStream file = fs.CreateFile(App.XMLIEDoc))
                   {
       ...
       private void CheckForallImages()
       {
           ...
           if (AllData != null)
           {
               ...
               {
                   data.Image = new BitmapImage(App.DefaultIEUri);
               }
           }
