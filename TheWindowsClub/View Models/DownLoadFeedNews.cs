...
{
  public class DownLoadFeedNews:BaseModel
    {
      public DownLoadFeedNews()
      {
          Oninit();
      }
      private void Oninit()
      ...
      private void AttachEvent()
      {
          FirstTile.ImaegLoaded += (s, e) =>
          {
              ...
              {
                  FirstTile.Image = new BitmapImage(App.DefaultdownLoadUri);
              }
          ...
          SeconTile.ImaegLoaded += (s, e) =>
          {
              ...
              {
                  SeconTile.Image = new BitmapImage(App.DefaultdownLoadUri);
              }
          };
          ThirdTile.ImaegLoaded += (s, e) =>
          {
              ...
              {
                  ThirdTile.Image = new BitmapImage(App.DefaultdownLoadUri);
              }
          };
          ForthTile.ImaegLoaded += (s, e) =>
          {
              ...
              {
                  ForthTile.Image = new BitmapImage(App.DefaultdownLoadUri);
              }
          ...
          FifthTile.ImaegLoaded += (s, e) =>
          {
              ...
              {
                  FifthTile.Image = new BitmapImage(App.DefaultdownLoadUri);
              }
          };
          SixthTile.ImaegLoaded += (s, e) =>
          {
              ...
              {
                  SixthTile.Image = new BitmapImage(App.DefaultdownLoadUri);
              }
          };
          SeventhTile.ImaegLoaded += (s, e) =>
          {
              ...
              {
                  SeventhTile.Image = new BitmapImage(App.DefaultdownLoadUri);
              }
          };
          EightthTile.ImaegLoaded += (s, e) =>
          {
              ...
              {
                  EightthTile.Image = new BitmapImage(App.DefaultdownLoadUri);
              }
          };
          NinthTile.ImaegLoaded += (s, e) =>
          {
              ...
              {
                  NinthTile.Image = new BitmapImage(App.DefaultdownLoadUri);
              }
          };
          TenthModel.ImaegLoaded += (s, e) =>
          {
              ...
              {
                  TenthModel.Image = new BitmapImage(App.DefaultdownLoadUri);
              }
      ...
      public void LoadRss()
      {
          Uri ur = new Uri(App.DownloadsFeedSource, UriKind.Absolute);
          ...
          wb.OpenReadCompleted += (s, e) =>
          {
              ...
              if (e.Error != null)
              {
                  ...
                  if (fs.FileExists(App.XMLDownDoc))
                  {
                      using (IsolatedStorageFileStream file = fs.OpenFile(App.XMLDownDoc, FileMode.Open, FileAccess.Read, FileShare.Read))
                      {
              ...
              else
              {
                  ...
                  if (fs.FileExists(App.XMLDownDoc))
                  {
                      fs.DeleteFile(App.XMLDownDoc);
                  }
                  using (IsolatedStorageFileStream file = fs.CreateFile(App.XMLDownDoc))
                  {
      ...
      private void CheckForallImages()
      {
          ...
          if (AllData != null)
          {
              ...
              {
                  data.Image = new BitmapImage(App.DefaultdownLoadUri);
              }
          }
